...
/**
 * Enhanced Screen 4 — identical to RefineOutlookScreen but with a violet aurora
 * hero and the enhanced stats panel (asset-curve gradient wash + shimmer
 * skeletons). The original stays untouched.
 */
export function RefineOutlookEnhancedScreen() {
      ...
      <div className="flex min-h-0 min-w-0 flex-col gap-3 pb-2 pr-1 lg:flex-1">
        ...
        >
          <h1 className="text-lg font-semibold leading-snug tracking-[-0.01em] text-deep-black">
            ...
            <span className="text-violet">risk level</span>
            {" you\u2019re comfortable with"}
          </h1>

          <div className="mt-4 grid grid-cols-1 gap-5 lg:grid-cols-[1.15fr_1fr]">
            {/* Risk slider */}
            <div className="flex flex-col justify-center rounded-card bg-white/70 px-5 py-4">
