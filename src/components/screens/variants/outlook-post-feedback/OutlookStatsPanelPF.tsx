...
/**
 * Right-hand text block in the detail view (mirrors the enhanced flow's layout).
 * Leads with the metric's real subtitle copy, then blocked-out placeholder
 * paragraphs so the column reads as a full explainer area, with an inert
 * "Learn more" link.
 */
...
/**
 * Post-feedback stats panel: same tabbed scaffolding as the shared panel, but
 * with the reworked success/assets/loss visuals and real subtitle copy. Used by
 * the post-feedback flow only.
 */
export function OutlookStatsPanelPF({
  current,
  personalized,
  comparison,
  fill,
